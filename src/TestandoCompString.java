...
public class TestandoCompString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Resultado do 1º teste com .equalsIgnoreCase:");
		System.out.println(nomeJedi1.equalsIgnoreCase("Luke SKYWALKER"));
		
		System.out.println("Resultado do 2º teste com .equalsIgnoreCase:");
		System.out.println(nomeJedi1.equalsIgnoreCase("Luke Skywalker"));
